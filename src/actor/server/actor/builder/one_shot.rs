...
/// One-shot actor builder. The build process can be execute only once.
pub struct OneShotActorBuilder {
    /// Generic builder
    builder: ActorBuilder,
    /// Optionals state handler which can be set by the builder
    ...
    R: 'static + Send + Debug,
{
    ...
    /// Build and start a request actor
